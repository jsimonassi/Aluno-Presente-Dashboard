...
const TableItem = (props: TableItemProps) => {
	...
	return (
		<tr>
			...
			<TdItemStyled index={props.index}>{props.currentStudent.cpf ?? ""}</TdItemStyled>
			<TdItemStyled index={props.index} style={{borderTopRightRadius: "8px", borderBottomRightRadius: "8px"}}>{props.currentStudent.ra ?? ""}</TdItemStyled>
		</tr>
	);
};
